 ...
 * 
 */
@WebServiceClient(name = "CollectionWSService", targetNamespace = "http://album.soap.com/", wsdlLocation = "http://localhost:8080/albums?wsdl")
    ...
    extends Service
{
    ...
    private final static QName COLLECTIONWSSERVICE_QNAME = new QName("http://album.soap.com/", "CollectionWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/albums?wsdl");
    ...
    public CollectionWS getCollectionWSPort() {
        return super.getPort(new QName("http://album.soap.com/", "CollectionWSPort"), CollectionWS.class);
    }
    ...
    public CollectionWS getCollectionWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://album.soap.com/", "CollectionWSPort"), CollectionWS.class, features);
    }
